...
const filterPrice = (price) => {
  ...
  return (
    <div className='bg-white mx-w-[1640px] m-auto px-4 py-12'>
    ...
    <div className='flex justify-between max-w-[390px] w-full'>
        ...
        <button onClick={()=> filterPrice('$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$5</button>
        <button onClick={()=> filterPrice('$$$')}className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$15</button>
        <button onClick={()=> filterPrice('$$$$')}className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$55</button>
    </div>
