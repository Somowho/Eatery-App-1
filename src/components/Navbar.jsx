...
const [nav, setNav] = useState(false)
  ...
  return (
    <div className='ma-w-[1640px] mx-auto flex justify-between items-center p-4'>
        {/*Left side */}
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>4tune<span className='font-bold'>Eats</span></h1>
...
<h2 className='text-2xl p-4 '>4tune <span className='font-bold'>Eats</span></h2>
